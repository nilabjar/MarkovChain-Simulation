...
public:
  ...
  int scheduling_states (State_List::iterator parent);

  void schedule_task (State_List::iterator parent, const char * state, float& p_value);
...
//  Task_List tasks;
  ...
  int create_edge (State_List::iterator parent,
...
private:
  ...
  void RM (State_List::iterator parent, const char * state, float& p_value);
  void LLF (State_List::iterator parent, const char * state, float& p_value);
  void SJF (State_List::iterator parent, const char * state, float& p_value);
  void EDF (State_List::iterator parent, const char * state, float& p_value);
  void DLJ (State_List::iterator parent, const char * state, float& p_value);
  void RND (State_List::iterator parent, const char * state, float& p_value);
  void PVAL (State_List::iterator parent, const char * state, float& p_value);

	void MLF (State_List::iterator parent, const char * state, float& p_value);
	void OPT (State_List::iterator parent, const char * state, float& p_value);
